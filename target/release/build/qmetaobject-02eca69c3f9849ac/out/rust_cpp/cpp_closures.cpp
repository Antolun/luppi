...
extern "C" {
    void (*rust_cpp_callbacks3992905739520888172[6])() = {};
}
...
#line 136 "src/itemmodel.rs"
            ...
            for (QModelIndex &idx : list2) {
                reinterpret_cast<void (*)(rustcpp::argument_helper<TraitObject>::type, rustcpp::argument_helper<QModelIndex &>::type)>(rust_cpp_callbacks3992905739520888172[0])(f, idx)
...
#line 163 "src/scenegraph.rs"
                ...
                if (raw->size != len || raw->type_id != type_id) {
                    reinterpret_cast<void (*)()>(rust_cpp_callbacks3992905739520888172[1])();
                }
                return raw->mask;
...
#line 224 "src/scenegraph.rs"
                ...
                if (raw->size != std::size_t(-1) || raw->type_id != type_id) {
                    reinterpret_cast<void (*)()>(rust_cpp_callbacks3992905739520888172[2])();
                }
                return raw->mask;
...
#line 255 "src/scenegraph.rs"
                ...
                if (!node) reinterpret_cast<void (*)()>(rust_cpp_callbacks3992905739520888172[3])();
...
#line 265 "src/scenegraph.rs"
                ...
                if (!node->parent()) {
                    ...
                    reinterpret_cast<void (*)()>(rust_cpp_callbacks3992905739520888172[4])();
                }
...
#line 443 "src/scenegraph.rs"
            ...
            if (!node->parent()) {
                ...
                reinterpret_cast<void (*)()>(rust_cpp_callbacks3992905739520888172[5])();
            }
            node->setFlag(QSGNode::OwnedByParent);
...
MetaData metadata_3992905739520888172 = {
